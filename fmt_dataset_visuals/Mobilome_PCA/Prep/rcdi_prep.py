...
plt.title('PCA of Aitchison Distances for Mobilome Samples (FMT Preparation rCDI)')
...
# metadata_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/metadata_for_rcdi_prep.csv", index=False)
...
# aitchison_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/aitchison_dist_matrix_rcdi_prep_mobilome.csv")
