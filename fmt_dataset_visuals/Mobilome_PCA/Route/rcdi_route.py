...
plt.xlim(merged_mobilome_df['PC1'].min() - 150, merged_mobilome_df['PC1'].max() + 150)
plt.ylim(merged_mobilome_df['PC2'].min() - 100, merged_mobilome_df['PC2'].max() + 150)

plt.xlabel('Principal Component 1')
plt.ylabel('Principal Component 2')
plt.legend(title='FMT Route', bbox_to_anchor=(1, 1), loc='upper right')
plt.grid(True)
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/Route/pca_rcdi.svg", format='svg', dpi=600, bbox_inches='tight')
...
metadata_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/Route/metadata_rcdi.csv", index=False)
...
aitchison_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/Route/aitchison_rcdi.csv")