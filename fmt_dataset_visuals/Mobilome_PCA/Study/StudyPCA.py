...
merged_mobilome_df = mobilome_features.merge(fmt_dataset[['run_accession', 'study_data']], 
...
# Ensuring no NaN values in 'study_data'
merged_mobilome_df['study_data'] = merged_mobilome_df['study_data'].fillna('Unknown')
