...
# # Save plot as SVG
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/Bowel/pca_mdrb.svg", format='svg', dpi=600, bbox_inches='tight')
plt.show()

# Save metadata: ID, fmt_prep, Patient
metadata_df = merged_mobilome_df[['ID', 'bowel_preparation', 'Patient']]
metadata_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/Bowel/metadata_mdrb.csv", index=False)
...
aitchison_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/Bowel/aitchison_mdrb.csv")