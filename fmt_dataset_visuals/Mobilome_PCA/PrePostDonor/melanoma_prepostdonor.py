...
ax = sns.scatterplot(x='PC1', y='PC2', hue='donor_pre_post_binned', data=merged_mobilome_df, palette=group_colors, alpha=0.7, edgecolor='k')
...
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/PrePostDonor/pca_melanoma.svg", format='svg', dpi=600, bbox_inches='tight', transparent=True)
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Mobilome_PCA/PrePostDonor/pca_melanoma.png", format='png', dpi=600, bbox_inches='tight', transparent=True)
plt.show()
...
aitchison_df = pd.DataFrame(aitchison_distances, index=merged_mobilome_df['ID'], columns=merged_mobilome_df['ID'])
