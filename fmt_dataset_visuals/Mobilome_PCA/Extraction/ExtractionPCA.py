...
# Merging mobilome features with DNA_extraction_kit from FMT dataset
merged_mobilome_df = mobilome_features.merge(fmt_dataset[['run_accession', 'DNA_extraction_kit']], 
...
# Ensuring no NaN values in 'DNA_extraction_kit'
merged_mobilome_df['DNA_extraction_kit'] = merged_mobilome_df['DNA_extraction_kit'].fillna('Unknown')
...
ax = sns.scatterplot(x='PC1', y='PC2', hue='DNA_extraction_kit', data=merged_mobilome_df, palette=kit_colors, alpha=0.7, edgecolor='k')
