...
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Extraction/pca_mdrb.svg", format='svg', dpi=600, bbox_inches='tight')
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Extraction/pca_mdrb.png", format='png', dpi=600, bbox_inches='tight', transparent=True)

plt.show()

# Save metadata: ID, fmt_prep, Patient
metadata_df = merged_df[['ID', 'DNA_extraction_kit', 'Patient']]
metadata_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Extraction/metadata_mdrb.csv", index=False)
...
aitchison_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Extraction/aitchison_mdrb.csv")