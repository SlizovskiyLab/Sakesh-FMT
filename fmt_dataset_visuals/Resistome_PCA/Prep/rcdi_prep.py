...
merged_df = resistance_features.merge(fmt_dataset[['run_accession', 'fmt_prep', 'Patient']], left_on='ID', right_on='run_accession', how='left')
...
plt.xlim(merged_df['PC1'].min() - 800, merged_df['PC1'].max() + 650)
plt.ylim(merged_df['PC2'].min() - 300, merged_df['PC2'].max() + 150)
...
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Prep/pca_rcdi.svg", format='svg', dpi=600, bbox_inches='tight', transparent = True)
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Prep/pca_rcdi.png", format='png', dpi=600, bbox_inches='tight', transparent = True)

plt.show()

# Save metadata: ID, fmt_prep, Patient
metadata_df = merged_df[['ID', 'fmt_prep', 'Patient']]
metadata_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Prep/metadata_rcdi.csv", index=False)
...
aitchison_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Prep/aitchison_rcdi.csv")
