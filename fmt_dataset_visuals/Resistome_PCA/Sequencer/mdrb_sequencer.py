...
plt.ylim(merged_df['PC2'].min() - 500, merged_df['PC2'].max() + 500)
...
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Sequencer/pca_mdrb.svg", format='svg', dpi=600, bbox_inches='tight', transparent = True)
plt.savefig("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Sequencer/pca_mdrb.png", format='png', dpi=600, bbox_inches='tight', transparent = True)

plt.show()

# Save metadata: ID, fmt_prep, Patient
metadata_df = merged_df[['ID', 'sequencer', 'Patient']]
metadata_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Sequencer/metadata_mdrb.csv", index=False)
...
aitchison_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/Sequencer/aitchison_mdrb.csv")