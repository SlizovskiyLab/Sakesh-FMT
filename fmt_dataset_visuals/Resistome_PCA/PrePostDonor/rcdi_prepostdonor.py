...
plt.title('PCA of Aitchison Distances for Resistome Samples (Donor/preFMT/postFMT)')
...
aitchison_df.to_csv("C:/Users/asake/OneDrive/Desktop/Homework/FMT/Resistome_PCA/PrePostDonor/aitchison_rcdi.csv")